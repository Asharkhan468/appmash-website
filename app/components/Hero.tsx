...
import heroTest from "@/public/hero1.png";
    ...
    <section className="bg-gray-900 text-white min-h-screen flex items-center justify-center px-4">
      <div className="max-w-5xl w-full grid md:grid-cols-2 gap-8 items-center">
        ...
        <div className="space-y-4 text-center md:text-left">
          <h1 className="text-4xl md:text-6xl font-bold">Test Layout</h1>
          <p className="text-gray-300">
            This is a simple hero layout for testing. If this works fine after deployment, your issue is inside the main HeroCarousel code.
          </p>
          <button className="bg-blue-500 px-6 py-2 rounded hover:bg-blue-600 transition">
            Test Button
          </button>
        </div>
